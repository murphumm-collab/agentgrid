...
export const runtimeContractKeys = ["token", "stakeManager", "agentRegistry", "rewardVault", "taskRegistry", "competitionSlotPassRegistry", "verificationPanel", "verificationArbitrationCourt", "disputeResolver", "protocolEconomics"] as const;
