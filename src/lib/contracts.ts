...
export const agentRegistryAbi = parseAbi([
  ...
  "function drawSelectionPanel(bytes32 poolId,uint8 maxPrunes) returns (address[3] winners,bool finalized,uint256 selectionBlock,bytes32 drawProof)",
  "function selectionPoolStatus(bytes32 poolId) view returns (uint256 selectionBlock,uint256 remainingWeight,uint8 selectedCount,bool complete,bytes32 drawProof)",
