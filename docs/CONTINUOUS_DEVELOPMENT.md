...
the OpenAPI 0.8.14 machine surface and economics dashboard projection pass locally. The
...
validator result are now removed as well; OpenAPI 0.8.14 uses `testerIds`,
...
Dashboard 2.5/OpenAPI 0.8.14 expose the closed anti-manipulation and public
...
an RPC or write failure can no longer silently replace validators. OpenAPI 0.8.14
...
Dashboard schema 2.5 and OpenAPI 0.8.14 now expose the exact advertising and
