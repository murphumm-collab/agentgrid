...
OpenAPI version 0.8.2 documents the complete supported public discovery, Agent
...
1. `POST /api/agent/jobs/lease` with `EXECUTOR`, `TESTER`, or `EVALUATOR`.
   OpenAPI 0.8.2 enumerates all eleven supported job kinds and maps each kind to
