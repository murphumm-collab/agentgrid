...
async function main() {
  ...
  await write("wire.stakeAgentRegistry", stakeManager, "StakeCreditManager", "setAgentRegistry", [agentRegistry]);
  await write("wire.agentRegistry", agentRegistry, "AgentRegistry", "setTaskRegistry", [taskRegistry]);
